 ...
 * @author chenx
 */
public class TagLayout extends CxhAreaSelectLayout
        implements TagAdapter.OnDataChangedListener {

    private TagAdapter mTagAdapter;
    private int mSelectedMax = -1;//-1不限制
    ...
    public interface OnTagClickListener {
        boolean onTagClick(View view, int position, CxhAreaSelectLayout parent);
    }
    ...
    public TagLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectedMax = ta.getInt(R.styleable.CxhAreaSelectLayout_max_select, -1);
        ta.recycle();
    }
